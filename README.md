...
- The student’s *roster identifier* (generated by `roster.jar` so the instructor can identify students in assignments without knowing their GitHub accounts), and
- The student’s *personal GitHub account* (required to create Teams and not included in the roster until the first assignment is accepted).
